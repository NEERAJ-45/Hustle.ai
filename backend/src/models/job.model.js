...
const JobSchema = new mongoose.Schema({
  ...
  detailedJD: {
    roleTitle: { type: String, trim: true, maxlength: 200 },
    experienceRange: { type: String, trim: true, maxlength: 100 },
    experienceDetails: [{ type: String, trim: true, maxlength: 500 }],
    ...
    specifications: [{ type: String, trim: true, maxlength: 500 }],
    aboutCompany: { type: String, trim: true, maxlength: 4000 },
    aboutHighlights: [{ type: String, trim: true, maxlength: 500 }],
    website: { type: String, trim: true, maxlength: 300 },
    backToOpeningsLabel: {
      type: String,
      trim: true,
      maxlength: 120,
      default: "Back to all openings",
    },
    shareText: {
      type: String,
      trim: true,
      maxlength: 200,
      default: "Share this opening with friends",
    },
    poweredBy: {
      type: String,
      trim: true,
