...
const jobSeeds=[ {
  ...
  company: {
    name: "Pixel Labs", industry: "SaaS", size: "Medium"
  }

  ,
  description: "Build performant frontend features using React and TypeScript.",
  ...
  salary: {
    min: 1200000, max: 1800000, currency: "INR", period: "Yearly"
  }
...
,
  ...
  company: {
    name: "Nova Systems", industry: "FinTech", size: "Large"
  }
  ...
  salary: {
    min: 1400000, max: 2200000, currency: "INR", period: "Yearly"
  }
...
,
  ...
  company: {
    name: "CloudOrbit", industry: "Cloud", size: "Enterprise"
  }
  ...
  salary: {
    min: 1800000, max: 2800000, currency: "INR", period: "Yearly"
  }
...
,
  ...
  title: "UI Engineer",
  company: {
    name: "DesignHive", industry: "DesignTech", size: "Small"
  }
  ...
  salary: {
    min: 800000, max: 1200000, currency: "INR", period: "Yearly"
  }
...
,
  ...
  company: {
    name: "DataForge", industry: "Data", size: "Startup"
  }
  ...
  salary: {
    min: 1100000, max: 1700000, currency: "INR", period: "Yearly"
  }
...
async function seedMatchesAndApplications(user, resume, jobs) {
  ...
  await Application.deleteMany( {
      userId: user._id, tags: "demo-seed"
    }

  );

  const statusPool=["New",
  "Applied",
  "Saved",
  "Viewed",
  "New"];
  const appStatusPool=[ "Submitted",
  "Under Review",
  "Interview Scheduled",
  "Offer Received",
  "Rejected",
  ...
  for (let index=0; index < jobs.length; index +=1) {
    ...
    await JobMatch.create( {
        ...
        scoreBreakdown: {
          ...
          ,
          experienceMatch: {
            score: 75, yearsMatch: true, roleMatch: true
          }
          ...
          ,
          salaryMatch: {
            score: 85, withinRange: true
          }

          ,
          preferenceMatch: {
            score: 82, jobTypeMatch: true, industryMatch: true
          }
    ...
    if (index < 4) {
      ...
      const interviews=statusCurrent==="Interview Scheduled"
