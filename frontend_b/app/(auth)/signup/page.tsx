      ...
      >
        ...
        <div className="text-center mb-8">
          <Link href="/" className="inline-flex items-center gap-2 mb-4">
            <div className="w-12 h-12 rounded-xl bg-gradient-to-r from-[#334e68] to-[#2563eb] flex items-center justify-center">
              <Sparkles className="w-6 h-6 text-white" />
            </div>
            <span className="text-2xl font-bold bg-gradient-to-r from-[#334e68] to-[#2563eb] bg-clip-text text-transparent">
              Hustle.ai
            </span>
          </Link>
        ...
        <Card className="shadow-xl border-0">
          <CardHeader>
            ...
            <CardDescription>Sign up to get started with Hustle.ai</CardDescription>
          </CardHeader>
          <CardContent className="space-y-6">
            ...
            <form className="space-y-4">
              ...
              <Button className="w-full bg-gradient-to-r from-[#334e68] to-[#2563eb] text-white" size="lg">
                Create Account
