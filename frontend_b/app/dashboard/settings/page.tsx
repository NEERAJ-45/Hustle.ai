              ...
              <Tabs defaultValue="profile">
                ...
                <TabsContent value="job" className="space-y-6">
                  <div className="space-y-4">
                    <div className="space-y-2">
                      ...
                      <Input id="jobTitle" defaultValue="Senior Frontend Engineer" />
                    </div>

                    <div className="grid md:grid-cols-2 gap-4">
                      <div className="space-y-2">
                        <Label htmlFor="minSalary">Minimum Salary</Label>
                        <Input id="minSalary" type="number" defaultValue="120000" />
                      </div>
                      <div className="space-y-2">
                        <Label htmlFor="maxSalary">Maximum Salary</Label>
                        <Input id="maxSalary" type="number" defaultValue="180000" />
                      </div>
                    </div>
                    ...
                    <div className="space-y-2">
                      ...
                      <Textarea id="skills" rows={3} defaultValue="React, TypeScript, Next.js, Tailwind CSS, Node.js" />
                    </div>
                      ...
                      <div className="space-y-4">
                        {[
                          ...
                          },
                          {
                            id: "messages",
                            label: "New messages",
                            description: "Messages from recruiters and hiring managers",
                          },
                        ].map((item) => (
                          <div
                            key={item.id}
                    ...
                    <div>
                      ...
                      <div className="space-y-4">
                        {[
                          ...
                          { id: "pushMessages", label: "Messages", description: "New messages and responses" },
                        ].map((item) => (
                          <div
                            key={item.id}
                            className="flex items-center justify-between p-4 border border-gray-200 rounded-lg"
                ...
                <TabsContent value="security" className="space-y-6">
                  <div className="space-y-4">
                    ...
                    <Button className="bg-gradient-to-r from-[#334e68] to-[#2563eb]">Update Password</Button>
                    ...
                    <div>
                      ...
                      <Card className="bg-gradient-to-r from-[#334e68] to-[#2563eb] text-white border-0">
                        <CardHeader>
                          ...
                          <CardDescription className="text-white/80">$29/month, billed monthly</CardDescription>
                        </CardHeader>
                        <CardContent>
                          <p className="text-sm mb-4">Next billing date: February 15, 2024</p>
                          <Button className="bg-white text-[#334e68] hover:bg-white/90">Manage Plan</Button>
                        </CardContent>
                      </Card>
                    </div>
