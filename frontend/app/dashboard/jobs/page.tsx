...
import { Search, MapPin, DollarSign, Briefcase, Clock, TrendingUp, Filter, Send, Bookmark } from "lucide-react"
...
const jobListings = [
  ...
  },
  {
    ...
    match: 87,
    posted: "3 days ago",
    description: "Creative agency seeking engineer with strong design skills...",
  ...
  return (
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} className="space-y-6">
            <div>
              ...
              <p className="text-white/80">AI-powered job matching finds the perfect opportunities for you</p>
            </div>
    ...
    export default function JobsPage() {
                ...
                <div className="flex items-end">
                  <Button className="w-full h-10 bg-gradient-to-r from-[#334e68] to-[#2563eb]">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        >
          {[
            ...
            { label: "Avg Match Rate", value: 94, suffix: "%", icon: TrendingUp },
            ...
            <Card>
              ...
              <CardContent className="space-y-6">
                ...
                <div className="space-y-3">
                  ...
                  <Slider defaultValue={[80]} max={300} step={10} className="py-4" />
                ...
                <div className="space-y-2">
                  ...
                  <Slider defaultValue={[85]} max={100} step={5} className="py-4" />
                  <p className="text-sm text-gray-600 text-center">85%+ match</p>
                </div>
          ...
          <div className="lg:col-span-3 space-y-4">
            <div className="flex items-center justify-between mb-4">
              <p className="text-sm text-gray-600">
                Showing <span className="font-semibold">{jobListings.length}</span> jobs
              </p>
