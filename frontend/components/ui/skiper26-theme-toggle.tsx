...
export const ThemeToggleButton = ({
  ...
  return (
    <button
      type="button"
      className={cn(
        "size-10 cursor-pointer rounded-full bg-black dark:bg-white p-0 transition-all duration-300 active:scale-95",
        className,
      )}
      onClick={toggleTheme}
...
/**
 * Skiper 26 Theme_buttons_002 — React + CSS + transition view api
