...
export function HowItWorksSection() {
  ...
  const steps = [
    {
      ...
      description:
        "Set up your professional profile with skills, experience, and career goals.",
    ...
    },
    {
      ...
      description:
        "Intelligent algorithm scans thousands of jobs to find your perfect matches.",
    ...
    },
    {
      ...
      description:
        "AI customizes your resume and generates tailored cover letters for each role.",
    ...
    },
    {
      ...
      description:
        "Apply to multiple jobs instantly. We handle all form filling automatically.",
    ...
    },
    {
      ...
      description:
        "Track responses, manage interviews, and get AI-powered preparation tips.",
    ...
    },
    {
      ...
      description:
        "Receive offer negotiation support and secure the best compensation package.",
  ...
  return (
    <section
      id="how-it-works"
      className="py-16 md:py-24 lg:py-32 bg-gradient-to-b from-white via-blue-50/20 to-white"
    >
            ...
            {steps.map((step) => (
              ...
              >
                <div className="flex md:flex-col items-center gap-4 md:gap-3 p-4 rounded-xl bg-white border border-gray-200 hover:border-blue-300 hover:shadow-lg transition-all">
                  {/* Step Number */}
                  <div
                    className={`relative z-10 w-12 h-12 rounded-xl bg-gradient-to-br ${step.color} flex items-center justify-center group-hover:scale-110 transition-transform`}
                  >
                ...
                <div className="grid lg:grid-cols-2 gap-8 md:gap-12 items-center">
                  ...
                  <div className="space-y-6">
                    <div className="flex items-center gap-4">
                      <div
                        className={`w-16 h-16 rounded-xl bg-gradient-to-br ${steps[activeStep - 1].color} flex items-center justify-center`}
                      >
                        {(() => {
                    ...
                    <div className="flex items-center gap-4 pt-4">
                      ...
                      <Button
                        onClick={() =>
                          setActiveStep((prev) =>
                            prev < steps.length ? prev + 1 : steps.length,
                          )
                        }
